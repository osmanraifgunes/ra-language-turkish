...
const frenchMessages: TranslationMessages = {
    ra: {
        action: {
            ...
            create_item : 'Nesne yarat',
            move_down : 'Aşağı taşı',
            move_up : 'Yukarı taşı',
            open : 'Aç',
            select_all : 'Tümünü seç',
            select_row : 'Satırı seç',
            toggle_theme : 'tmeayı değiştir',
            update:  'Güncelle'
        },
        boolean: {
            true: 'Evet',
        ...
        message: {
            ...
            unsaved_changes:
                ...
                bulk_update_content:'Bu %{name} güncellemek istediğinizden emin misiniz? |||| %{smart_count} adet kaydı güncellemek istediğinizden emin misiniz?',
                bulk_update_title : '%{name} güncelle |||| %{smart_count} adet %{name} güncelle.',
        },
        navigation: {
            ...
            page : 'Sayfa %{page} git',
            partial_page_range_info : ' %{offsetEnd} kayıtın %{offsetBegin}-%{offsetEnd} arası görüntüleniyor.',
            previous : 'Önceki sayfaya git',
            skip_nav: 'İçeriğe git'
        },
        sort: {
        ...
        notification: {
            ...
            not_authorized : 'Bu kaynağa rerişim yetkiniz yok.'
        },
        validation: {
        ...
        saved_queries: {
            ...
            new_label: 'Sorguyu kaydet...',
            new_dialog_title: 'Mecut sorguyu çyle kaydet : ',
            remove_label: 'Kayıtlı sorguyu sil.',
            remove_label_with_name: 'Sorguyu sil: "%{name}"',
            remove_dialog_title: 'Kayıtlı sorguyu silsin mi?',
            remove_message:
                'Bu sorguyu kayıtlı sorgularınızdan silmek istediğinize eminmisiniz?',
            help: 'Listeyi filtrele ve bu sorguyu daha sonrası için kaydet.',
        },
